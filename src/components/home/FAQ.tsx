...
const QUESTIONS = [
  ...
  },
  {
    ...
    a: 'Заменим следующее без вопросов. На «Знакомстве» это нормальная часть процесса — мы учимся вашему вкусу. Если что-то совсем мимо — возвращаем деньги за конкретную посылку.',
  },
  {
    q: 'Молотое или зерно? Что выбрать?',
